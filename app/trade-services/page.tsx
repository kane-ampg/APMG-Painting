  ...
  return (
    <>
      ...
      <Hero
        ...
        crumbs={[{ name: 'Builders & head contractors', path: '/trade-services/' }]}
      />
      ...
      <MediaBand
        ...
        caption="Making good where new work meets an existing wall, on a fit-out still in progress. Preparation gets measured and priced at this stage, before a brush is opened — and it is the stage a construction programme most often leaves too little room for."
      />
